...
echo "--- e2e: the missing 2x2 cell, and repack at the prod width ---"
run_e2e "ctrl-n6-pre"          1 GGML_MM_SKINNY=5 -md "$MD" --spec-type draft-dflash --spec-draft-n-max 6
run_e2e "n3-skinny5-repack"    2 GGML_MM_SKINNY=5 GGML_MV_REPACK=1 -md "$MD" --spec-type draft-dflash --spec-draft-n-max 3
run_e2e "n6-skinny5-repack"    2 GGML_MM_SKINNY=5 GGML_MV_REPACK=1 -md "$MD" --spec-type draft-dflash --spec-draft-n-max 6
run_e2e "n6-skinny4-repack"    2 GGML_MM_SKINNY=4 GGML_MV_REPACK=1 -md "$MD" --spec-type draft-dflash --spec-draft-n-max 6
