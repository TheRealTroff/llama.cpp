...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_gated_delta_net   (ggml_metal_library_t lib, const struct ggml_tensor * op, bool wb, bool xk);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_q4_0_soa_w1(ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_q4_0_soa_w2(ggml_metal_library_t lib);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_iq4_xs_soa_w4(ggml_metal_library_t lib, int variant);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_kq_soa_w4  (ggml_metal_library_t lib, enum ggml_type type, int variant);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_turbo_wht         (ggml_metal_library_t lib, const struct ggml_tensor * op);
