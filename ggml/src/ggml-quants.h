...
// TurboQuant KV-cache types (ggml-turbo-quant.c)
...
// in-place normalized signed WHT on one 128-element group; direction 0 = forward, 1 = inverse
GGML_API void ggml_turbo_wht_group(float * x, int direction);
